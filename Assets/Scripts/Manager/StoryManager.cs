...
public class StoryManager : MonoBehaviour
{
    ...
    {
        StreamReader sr = new StreamReader(Application.dataPath + "/Storys/" + fileName);   //대본 파일(후에 리스트로 관리해야 함)
        ...
        List<List<string>> actionSetList = new List<List<string>>(); //대사 한줄에 따른 연출들을 저장하는 리스트
